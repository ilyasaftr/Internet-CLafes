...
public class ViewJobDetail {
	 ...
	 */
	private void initialize(ViewJobDetailVar components) {
	...
	private void getData(Integer jobID, ViewJobDetailVar components) {
	 ...
	 */
	private void setStyle(ViewJobDetailVar components) {
	 ...
	 */
	public void initPage(String role, Integer jobID, ViewAllJobVar components2) {
		// TODO Auto-generated method stub
		JobController jc = JobController.getInstance();
		ViewJobDetailVar components = new ViewJobDetailVar();
		...
		jc.addUpdateJobHandler(components, components2);
		
		components.stage.show();
	}
	
	// inisialisasi isi dari alert yang akan dimunculkan
	private void initializeAlert(ViewJobDetailVar components) {
